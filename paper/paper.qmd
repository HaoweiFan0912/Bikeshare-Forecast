---
title: "Prediction of Shared Bicycle Usage at the University of Toronto St. George Campus Using Bayesian Poisson Regression"
subtitle: "Usage has risen sharply, with a steep decline in winter, and 79.8% occurs between 8 AM and 8 PM"
author: 
  - Haowei Fan
...
packages <- c("tidyverse", "dplyr", "arrow", "ggplot2", "RColorBrewer", "knitr", "bayesplot", "kableExtra")
...
## Overview
Bike-sharing services have undoubtedly improved commuting efficiency, especially for short trips within a campus. For example, a study on bike-sharing in Xiamen, China, highlighted how data-driven analyses can inform policymakers about system performance, thereby guiding investments and policy decisions to enhance urban mobility[@xiamen]. However, in the Toronto region, despite a study by the University of Toronto's School of Cities showing that ridership increased from about 665,000 trips in 2015 to over 4.5 million in 2022[@liu2023bike], there has been little research focused on small-scale areas, such as universities, within Toronto. Furthermore, a study from Hangzhou, China, confirmed the significant differences in traveling characteristics between cities and university campuses[@hangzhou]. Therefore, this paper takes the University of Toronto as a case study to analyze bike-sharing usage within the campus.
...
The paper proceeds as follows: @sec-data outlines the data sources, processing techniques, and the variables employed in the study. @sec-model describes the Bayesian Poisson regression model used for prediction, including its formulation and validation. @sec-result discusses the results, emphasizing temporal and station-specific patterns in bike-sharing usage. @sec-discussion concludes with a discussion of the study’s contributions, limitations, and recommendations for future research. 
