---
title: "Datasheet for 'Bike Share Toronto Ridership Data'"
author: 
  - Haowei Fan
thanks: "Dataset are available at: https://open.toronto.ca/dataset/bike-share-toronto-ridership-data/."
date: today
date-format: long
format: pdf
...
The dataset is named "Bike Share Toronto Ridership Data" [@bikesharedata]. It was sourced from Open Data Toronto [@opendata], uploaded by the Toronto Parking Authority [@greenp], and collected by Bike Share Toronto [@bike]. The questions in the datasheet originate from "Datasheets for Datasets"[@gebru2021datasheets].
...
1. *Has the dataset been used for any tasks already? If so, please provide a description.*
	- The dataset has been used for analyzing bike-sharing patterns, understanding peak usage times, and informing city planning and transportation policies. For example, the University of Toronto's School of Cities [@liu2023bike] has studied the general patterns of bike-sharing in the Toronto region.
...
3. *What (other) tasks could the dataset be used for?*
	- he dataset could be used for tasks such as predicting future bike demand, identifying underserved areas, or analyzing the impact of weather on bike usage.
